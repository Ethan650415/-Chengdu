const CACHE_NAME="chengdu-trip-cn-v27";
const PRECACHE=["./", "./index.html", "./styles.css?v=27", "./app.js?v=27", "./manifest.webmanifest", "./icons/icon-192.png", "./icons/icon-512.png", "./assets/city.svg", "./assets/dessert.svg", "./assets/hero.svg", "./assets/hotpot.svg", "./assets/lake.svg", "./assets/mountain.svg", "./assets/noodles.svg", "./assets/panda.svg", "./assets/sidebar.svg", "./assets/snack.svg", "./assets/tea.svg"];
