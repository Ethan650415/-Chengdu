...
const images = {
  city: { src: "./assets/photos/chunxi.jpg?v=27", fallback: "./assets/city.svg", alt: "成都春熙路" },
  taikoo: { src: "./assets/photos/taikoo.jpg?v=27", fallback: "./assets/city.svg", alt: "成都太古里" },
  jinli: { src: "./assets/photos/jinli.jpg?v=27", fallback: "./assets/city.svg", alt: "成都錦里古街" },
  peoplesPark: { src: "./assets/photos/peoples_park.jpg?v=27", fallback: "./assets/tea.svg", alt: "成都人民公園茶館" },
  kuanzhai: { src: "./assets/photos/kuanzhai.jpg?v=27", fallback: "./assets/city.svg", alt: "成都寬窄巷子" },
  opera: { src: "./assets/photos/sichuan_opera.jpg?v=27", fallback: "./assets/city.svg", alt: "川劇變臉" },

  dujiangyan1: { src: "./assets/photos/dujiangyan_1.jpg?v=27", fallback: "./assets/lake.svg", alt: "都江堰" },
  dujiangyan2: { src: "./assets/photos/dujiangyan_2.jpg?v=27", fallback: "./assets/lake.svg", alt: "都江堰水利景觀" },
  songpan1: { src: "./assets/photos/songpan_1.jpg?v=27", fallback: "./assets/city.svg", alt: "松潘古城" },
  songpan2: { src: "./assets/photos/songpan_2.jpg?v=27", fallback: "./assets/city.svg", alt: "松潘老城" },

  huanglong1: { src: "./assets/photos/huanglong_1.jpg?v=27", fallback: "./assets/mountain.svg", alt: "黃龍彩池" },
  huanglong2: { src: "./assets/photos/huanglong_2.jpg?v=27", fallback: "./assets/mountain.svg", alt: "黃龍多彩鈣華池" },
  huanglong3: { src: "./assets/photos/huanglong_3.jpg?v=27", fallback: "./assets/mountain.svg", alt: "黃龍瀑布" },

  jiuzhaigou1: { src: "./assets/photos/jiuzhaigou_1.jpg?v=27", fallback: "./assets/lake.svg", alt: "九寨溝五花海" },
  jiuzhaigou2: { src: "./assets/photos/jiuzhaigou_2.jpg?v=27", fallback: "./assets/lake.svg", alt: "九寨溝長海" },
  jiuzhaigou3: { src: "./assets/photos/jiuzhaigou_3.jpg?v=27", fallback: "./assets/lake.svg", alt: "九寨溝諾日朗瀑布" },

  leshan1: { src: "./assets/photos/leshan_1.jpg?v=27", fallback: "./assets/lake.svg", alt: "樂山大佛" },
  leshan2: { src: "./assets/photos/leshan_2.jpg?v=27", fallback: "./assets/lake.svg", alt: "樂山大佛景區" },
  emei1: { src: "./assets/photos/emei_1.jpg?v=27", fallback: "./assets/mountain.svg", alt: "峨眉山金頂" },
  emei2: { src: "./assets/photos/emei_2.jpg?v=27", fallback: "./assets/mountain.svg", alt: "峨眉山風景" },

  panda1: { src: "./assets/photos/panda_1.jpg?v=27", fallback: "./assets/panda.svg", alt: "成都熊貓基地" },
  panda2: { src: "./assets/photos/panda_2.jpg?v=27", fallback: "./assets/panda.svg", alt: "大熊貓" },
  pandaEntrance: { src: "./assets/photos/panda_entrance.jpg?v=27", fallback: "./assets/panda.svg", alt: "熊貓基地入口" },
  sanxingdui1: { src: "./assets/photos/sanxingdui_1.jpg?v=27", fallback: "./assets/city.svg", alt: "三星堆博物館" },
  sanxingdui2: { src: "./assets/photos/sanxingdui_2.jpg?v=27", fallback: "./assets/city.svg", alt: "三星堆金面具" },
  sanxingdui3: { src: "./assets/photos/sanxingdui_3.jpg?v=27", fallback: "./assets/city.svg", alt: "三星堆展館" },

  hotpot: { src: "./assets/photos/food_hotpot.jpg?v=27", fallback: "./assets/hotpot.svg", alt: "成都火鍋" },
  dumplings: { src: "./assets/photos/food_dumplings.jpg?v=27", fallback: "./assets/noodles.svg", alt: "鐘水餃" },
  mapoTofu: { src: "./assets/photos/food_mapotofu.jpg?v=27", fallback: "./assets/hotpot.svg", alt: "麻婆豆腐" },
  noodles: { src: "./assets/noodles.svg", alt: "麵食" },
  snack: { src: "./assets/snack.svg", alt: "四川小吃" },
  dessert: { src: "./assets/dessert.svg", alt: "甜品" },
  tea: { src: "./assets/tea.svg", alt: "成都茶文化" },
};
...
const itinerary = [
  {
    ...
    photos: [
      { ...images.city, caption: "春熙路" },
      { ...images.taikoo, caption: "成都太古里" },
      { ...images.hotpot, caption: "成都第一頓火鍋" },
    ],
    items: [
      {
        time: "出發",
  ...
  },
  {
    ...
    photos: [
      { ...images.dujiangyan1, caption: "都江堰" },
      { ...images.dujiangyan2, caption: "都江堰水利景觀" },
    ],
    items: [
      {
        time: "上午",
  ...
  },
  {
    ...
    theme: "上行索道＋動車到五彩池",
    photos: [
      { ...images.huanglong1, caption: "黃龍彩池" },
      { ...images.huanglong2, caption: "多彩鈣華池" },
      { ...images.huanglong3, caption: "黃龍瀑布" },
    ],
    items: [
      {
        time: "上午",
  ...
  },
  {
    ...
    photos: [
      { ...images.jiuzhaigou1, caption: "五花海" },
      { ...images.jiuzhaigou2, caption: "長海" },
      { ...images.jiuzhaigou3, caption: "諾日朗瀑布" },
      { ...images.songpan1, caption: "松潘古城" },
    ],
    items: [
      {
        time: "全天",
  ...
  },
  {
    ...
    theme: "下午奎星樓街或按摩休息",
    photos: [
      { ...images.songpan2, caption: "松潘老城" },
      { ...images.city, caption: "回到成都" },
      { ...images.hotpot, caption: "成都晚餐" },
    ],
    items: [
      {
        time: "上午",
  ...
  },
  {
    ...
    photos: [
      { ...images.leshan1, caption: "樂山大佛" },
      { ...images.leshan2, caption: "樂山大佛景區" },
      { ...images.emei2, caption: "前往峨眉山" },
    ],
    items: [
      {
        time: "上午",
  ...
  },
  {
    ...
    theme: "景區觀光車＋索道為主",
    photos: [
      { ...images.emei1, caption: "峨眉山金頂" },
      { ...images.emei2, caption: "峨眉山風景" },
    ],
    items: [
      {
        time: "全天",
  ...
  },
  {
    ...
    photos: [
      { ...images.panda1, caption: "熊貓基地" },
      { ...images.panda2, caption: "大熊貓" },
      { ...images.sanxingdui1, caption: "三星堆博物館" },
      { ...images.sanxingdui2, caption: "三星堆金面具" },
      { ...images.jinli, caption: "錦里古街" },
    ],
    items: [
      {
        time: "最早時段",
  ...
  },
  {
    ...
    theme: "自由活動＋川劇變臉",
    photos: [
      { ...images.peoplesPark, caption: "人民公園茶館" },
      { ...images.kuanzhai, caption: "寬窄巷子" },
      { ...images.opera, caption: "川劇變臉" },
    ],
    items: [
      {
        time: "上午",
  ...
  },
  {
    ...
    photos: [
      ...
      { ...images.taikoo, caption: "See you, Chengdu" },
    ],
    items: [
      {
        time: "上午",
...
const restaurants = [
  ...
  },,
  {
    ...
    body: "成都代表性紅油水餃，適合市區自由活動時就近安排。",
    links: [{ label: "附近鐘水餃", url: mapLink("成都 鐘水餃") }],
  },
  {
    name: "麻婆豆腐",
    type: "川菜",
    area: "成都",
    day: "Day 5 / Day 9",
    image: images.mapoTofu,
    body: "四川代表菜，適合與其他川菜一起點桌菜分食。",
    links: [{ label: "附近麻婆豆腐", url: mapLink("成都 麻婆豆腐 川菜") }],
  }
];


const galleryPhotos = [
  { group: "成都", caption: "春熙路", image: images.city },
  { group: "成都", caption: "成都太古里", image: images.taikoo },
  { group: "成都", caption: "錦里古街", image: images.jinli },
  { group: "成都", caption: "人民公園茶館", image: images.peoplesPark },
  { group: "成都", caption: "寬窄巷子", image: images.kuanzhai },
  { group: "成都", caption: "川劇變臉", image: images.opera },
  { group: "川西", caption: "都江堰", image: images.dujiangyan1 },
  { group: "川西", caption: "都江堰水利景觀", image: images.dujiangyan2 },
  { group: "川西", caption: "松潘古城", image: images.songpan1 },
  { group: "川西", caption: "松潘老城", image: images.songpan2 },
  { group: "黃龍", caption: "黃龍彩池", image: images.huanglong1 },
  { group: "黃龍", caption: "多彩鈣華池", image: images.huanglong2 },
  { group: "黃龍", caption: "黃龍瀑布", image: images.huanglong3 },
  { group: "九寨溝", caption: "五花海", image: images.jiuzhaigou1 },
  { group: "九寨溝", caption: "長海", image: images.jiuzhaigou2 },
  { group: "九寨溝", caption: "諾日朗瀑布", image: images.jiuzhaigou3 },
  { group: "樂山峨眉", caption: "樂山大佛", image: images.leshan1 },
  { group: "樂山峨眉", caption: "樂山大佛景區", image: images.leshan2 },
  { group: "樂山峨眉", caption: "峨眉山金頂", image: images.emei1 },
  { group: "樂山峨眉", caption: "峨眉山風景", image: images.emei2 },
  { group: "熊貓三星堆", caption: "熊貓基地", image: images.panda1 },
  { group: "熊貓三星堆", caption: "大熊貓", image: images.panda2 },
  { group: "熊貓三星堆", caption: "熊貓基地入口", image: images.pandaEntrance },
  { group: "熊貓三星堆", caption: "三星堆博物館", image: images.sanxingdui1 },
  { group: "熊貓三星堆", caption: "三星堆金面具", image: images.sanxingdui2 },
  { group: "熊貓三星堆", caption: "三星堆展館", image: images.sanxingdui3 },
  { group: "四川美食", caption: "成都火鍋", image: images.hotpot },
  { group: "四川美食", caption: "鐘水餃", image: images.dumplings },
  { group: "四川美食", caption: "麻婆豆腐", image: images.mapoTofu },
];
...
function renderGalleryFilters() {
  ...
  const filters = ["全部", ...new Set(galleryPhotos.map((photo) => photo.group))];
  galleryFilters.innerHTML = filters.map((filter) => `
    <button class="filter-pill ${filter === selectedGalleryType ? "is-active" : ""}" data-gallery-filter="${escapeHtml(filter)}">${escapeHtml(filter)}</button>
  `).join("");
  galleryFilters.querySelectorAll("button").forEach((button) => {
    button.addEventListener("click", () => {
      selectedGalleryType = button.dataset.galleryFilter;
...
function renderGallery() {
  ...
  const visible = selectedGalleryType === "全部" ? galleryPhotos : galleryPhotos.filter((photo) => photo.group === selectedGalleryType);
  galleryGrid.innerHTML = visible.map((photo, index) => `
    <figure class="gallery-card ${index % 7 === 0 ? "gallery-card-wide" : ""}">
      <img src="${safeExternalUrl(photo.image.src)}" data-fallback="${escapeHtml(photo.image.fallback || "")}" alt="${escapeHtml(photo.image.alt)}" loading="lazy" />
      <figcaption><span>${escapeHtml(photo.group)}</span><strong>${escapeHtml(photo.caption)}</strong></figcaption>
    </figure>
  `).join("");
}
