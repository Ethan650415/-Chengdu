...
const TIME_PLAN = [{"date": "9/18", "title": "抵達成都", "highlight": "城市暖身日", "rows": [["18:05前後", "成都機場", "抵達，與司機會合"], ["19:30", "西蜀天际", "辦理入住、放行李"], ["20:30", "春熙路", "晚餐與散步開始"], ["21:15", "太古里", "逛街、拍照"], ["22:30", "回飯店", "早點休息"]]}, {"date": "9/19", "title": "成都→都江堰→川主寺", "highlight": "長拉車日", "rows": [["08:00", "成都出發", "正式往川西移動"], ["10:00", "都江堰", "景區停留、簡單午餐"], ["12:30", "離開都江堰", "繼續往川主寺"], ["18:00", "川主寺", "抵達住宿區"], ["19:30", "川主寺晚餐", "牦牛肉／高原風味"]]}, {"date": "9/20", "title": "黃龍一日遊", "highlight": "高海拔景區日", "rows": [["07:30", "川主寺出發", "往黃龍景區"], ["09:00", "黃龍索道口", "準備上行"], ["10:00", "五彩池區", "核心景觀時段"], ["15:30", "離開黃龍", "往九寨溝口"], ["18:00", "九寨溝口", "入住、早休息"]]}, {"date": "9/21", "title": "九寨溝→松潘", "highlight": "整天景區日", "rows": [["07:30", "九寨溝景區口", "排隊入園"], ["08:00", "景區觀光車", "開始全天遊覽"], ["12:30", "景區內", "午餐或簡單補給"], ["17:00", "離開九寨溝", "前往松潘"], ["19:00", "松潘古城", "入住、散步晚餐"]]}, {"date": "9/22", "title": "松潘→成都", "highlight": "回到成都", "rows": [["08:30", "松潘出發", "返回成都"], ["12:30", "途中服務站", "午餐休息"], ["16:30", "豪阔遇上酒店", "入住成都飯店"], ["18:30", "奎星樓街／按摩", "看體力安排"], ["21:00", "回飯店", "調整休息"]]}, {"date": "9/23", "title": "樂山大佛→峨眉", "highlight": "美食重點日", "rows": [["07:30", "成都出發", "往樂山"], ["10:30", "樂山碼頭／遊船", "看大佛"], ["12:30", "樂山市區", "午餐吃蹺腳牛肉等"], ["15:30", "前往峨眉山", "移動至報國寺區域"], ["17:00", "柏隐汤泉智能酒店", "入住休息"]]}, {"date": "9/24", "title": "峨眉山金頂→成都", "highlight": "金頂＋夜市", "rows": [["07:00", "前往高山區", "搭觀光車、索道"], ["09:30", "金頂", "主景點停留"], ["15:30", "下山返程", "回成都"], ["19:30", "撫琴夜市", "晚間逛吃"], ["21:30", "豪阔遇上酒店", "回飯店"]]}, {"date": "9/25", "title": "熊貓基地→青城山／三星堆→錦里", "highlight": "兩段重點行程", "rows": [["07:30", "熊貓基地", "最早時段入園"], ["11:30", "離開熊貓基地", "簡單午餐"], ["14:30", "青城山／三星堆", "下午二選一行程"], ["18:30", "錦里", "晚上散步吃小點"], ["21:00", "豪阔遇上酒店", "回成都住宿"]]}, {"date": "9/26", "title": "成都慢慢玩", "highlight": "慢節奏收尾", "rows": [["09:30", "人民公園", "喝茶放空"], ["12:30", "午餐", "補吃想吃的"], ["14:00", "寬窄巷子", "散步拍照"], ["19:00", "川劇變臉", "最後一晚表演"], ["21:30", "豪阔遇上酒店", "回飯店整理行李"]]}, {"date": "9/27", "title": "送機返程", "highlight": "依航班分兩次送機", "rows": [["08:30", "飯店早餐／整理", "退房前確認行李"], ["09:30", "第一趟送機", "依旅行社安排"], ["10:30", "第二趟送機", "依旅行社安排"], ["11:30", "機場報到", "預留報到時間"], ["返程", "離開成都", "結束旅程"]]}];
const FOOD_MEDIA = {
