const CACHE_NAME="chengdu-trip-cn-v25";
const PRECACHE=["./", "./index.html", "./styles.css?v=25", "./app.js?v=25", "./manifest.webmanifest", "./icons/icon-192.png", "./icons/icon-512.png", "./assets/city.svg", "./assets/dessert.svg", "./assets/hero.svg", "./assets/hotpot.svg", "./assets/lake.svg", "./assets/mountain.svg", "./assets/noodles.svg", "./assets/panda.svg", "./assets/sidebar.svg", "./assets/snack.svg", "./assets/tea.svg"];
